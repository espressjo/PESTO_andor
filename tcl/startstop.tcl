...
global rpcid
set rpcid(client) [dp_MakeRPCClient 132.204.61.49 5004]
...
set rpcid(serveur) [dp_MakeRPCServer 5005]
# --- Demande au serveur de se connecter au "serveur" du client
send {set rpcid(client) [dp_MakeRPCClient 132.204.61.49 5005]}

proc startstop args {
	send { set stop_acq $args }
}
